...
deploy: create-pull-secret deploy-prometheus deploy-fluent-bit deploy-otel-collector
...
deploy-otel-collector:
	...
	@kubectl --context $(K8S_CONTEXT) apply -f deploy/lab-3/

undeploy-otel-collector:
	@echo "--- Deleting OTel Collector ---"
	@kubectl --context $(K8S_CONTEXT) delete -f deploy/lab-3/ || true

# Deletes the applications from Kubernetes
undeploy: delete-pull-secret undeploy-prometheus undeploy-fluent-bit undeploy-otel-collector
